    ...
    public void init() {
        ...
        this.rules.setText(
                "BomberOne, arcade game where the main objective is to destroy all the boxes and kill all the enemies within the time limit.\n"
                        ...
                        + "Whenever the Bomber dies, all PowerUps (except TimerInc) will be deactivated. At the beginning of the game it will be possible to choose between two different levels, the first one called \"Easy\" is the less difficult, will generates 3 enemies, that, once dead, will no longer be present in the map, whereas the second one, called \"Hard\", the most difficult, will generetes more boxes and the enemies can respawn until until there will be boxes on the map. ");
    }
