...
public class RulesViewImpl extends ViewImpl implements RulesView {
    ...
    @FXML
    private ImageView rulesLogo;

    @FXML
    private ImageView backToHome;

    @FXML
    private ImageView firePower;

    @FXML
    private ImageView speedPower;

    @FXML
    private ImageView bombPower;

    @FXML
    private ImageView piercePower;

    @FXML
    private Label rules;

    @FXML
    private ImageView timePower;
    ...
    public void drawRules() {
        this.rulesLogo.setImage(GameImages.RULES.getImage());
        this.backToHome.setImage(GameImages.QUIT_GAME.getImage());
        this.firePower.setImage(GameImages.POWER_FIREPOWER.getImage());
        this.speedPower.setImage(GameImages.POWER_SPEED.getImage());
        this.bombPower.setImage(GameImages.POWER_BOMB.getImage());
        this.piercePower.setImage(GameImages.POWER_PIERCE.getImage());
        this.timePower.setImage(GameImages.POWER_TIMER.getImage());
    }
