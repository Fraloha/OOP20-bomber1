...
import bomber.controllers.game.input.commands.Command;
import bomber.controllers.game.input.commands.MoveDown;
import bomber.controllers.game.input.commands.MoveLeft;
import bomber.controllers.game.input.commands.MoveRight;
import bomber.controllers.game.input.commands.MoveUp;
import bomber.controllers.game.input.commands.PlantBomb;
